...
pub const _ids = .{
    ...
    "1vv8d3ee4k0g7kmy1bhi9qon55bj1arxq9181hc8sesa7x3f",
...
pub const _paths = .{
    ...
    "/v/git/github.com/truemedian/zfetch/commit-5b9d6a2/",
    ...
    "/v/git/github.com/nektro/zig-json/commit-ad4232e/",
};
...
pub const package_data = struct {
    ...
    pub const _1vv8d3ee4k0g7kmy1bhi9qon55bj1arxq9181hc8sesa7x3f = std.build.Pkg{ .name = "uri", .path = cache ++ "/git/github.com/MasterQ32/zig-uri/uri.zig", .dependencies = &[_]std.build.Pkg{ } };
    pub const _ejw82j2ipa0eul25ohgdh6yy5nkrtn2pf0rq18m0079w6wj7 = std.build.Pkg{ .name = "zfetch", .path = cache ++ "/v/git/github.com/truemedian/zfetch/commit-5b9d6a2/src/main.zig", .dependencies = &[_]std.build.Pkg{ _9k24gimke1anv665ilg4si32ayl3dsaqgmdfdpu1ceoky8tl, _csbnipaad8n77buaszsnjvlmn6j173fl7pkprsctelswjywe, _yyhw90zkzgmubwpp87n0pzf936n850an66y1c6qan5y6sogv, _1vv8d3ee4k0g7kmy1bhi9qon55bj1arxq9181hc8sesa7x3f, } };
    pub const _ocmr9rtohgccd6gm6tp8b1yzylyzkqwvo1q4btrsvj0cse9y = std.build.Pkg{ .name = "json", .path = cache ++ "/v/git/github.com/nektro/zig-json/commit-ad4232e/src/lib.zig", .dependencies = &[_]std.build.Pkg{ } };
